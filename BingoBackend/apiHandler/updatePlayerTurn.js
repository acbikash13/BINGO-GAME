...
async function updatePlayerTurn(gameId, userId) {
    ...
    try {
        ...
        console.log("Game document is " + JSON.stringify(gameDocument));
        ...
        console.log(" Player state is " + JSON.stringify(playerState));
        ...
        console.log("new Game document after updating the player turn is" + typeof(gameDocument));
        ...
        if (updatePlayerTurn.modifiedCount === 1) {
            ...
            console.log("Player turn Update was not successfull successfull")
